...
import spaceapps.alvaro.caringfornature.Fragmentos.AlertaFragment.OnListFragmentInteractionListener;
...
public class MyAlertaRecyclerViewAdapter extends RecyclerView.Adapter<MyAlertaRecyclerViewAdapter.ViewHolder> {
    ...
    public MyAlertaRecyclerViewAdapter(List<DummyItem> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
